...
import { Bell, Search, User, Menu, ChevronLeft, ChevronRight, X, PanelLeft } from "lucide-react";
...
export function TopBar({ isCollapsed, onToggleCollapse, onMobileMenuClick }: TopBarProps) {
    return (
